InstructionRunnerReturn oraImmediate(CPU& cpu, const Instruction& instruction) {
...
InstructionRunnerReturn oraZeroPage(CPU& cpu, const Instruction& instruction) {
...
InstructionRunnerReturn oraZeroPageX(CPU& cpu, const Instruction& instruction) {
...
InstructionRunnerReturn oraAbsolute(CPU& cpu, const Instruction& instruction) {
...
InstructionRunnerReturn oraAbsoluteX(CPU& cpu, const Instruction& instruction) {
...
InstructionRunnerReturn oraAbsoluteY(CPU& cpu, const Instruction& instruction) {
...
InstructionRunnerReturn oraIndirectX(CPU& cpu, const Instruction& instruction) {
...
InstructionRunnerReturn oraIndirectY(CPU& cpu, const Instruction& instruction) {
